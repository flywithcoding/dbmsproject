...
if ($featuredResult && $featuredResult->num_rows > 0) {
  while ($parking = $featuredResult->fetch_assoc()) {
    ...
    // এই লাইনটা এখানে যোগ করুন:
    // শুধু Closed এবং Maintenance garages skip করুন:
if ($garageStatus['status'] === 'Closed' || $garageStatus['status'] === 'Maintenance') {
    continue; // বন্ধ থাকলে এই কার্ড স্কিপ করো
}
  ...
  <script>
    ...
    `;
        ...
        function performSearch(query, map) {
          // যদি জিওকোডার আছে, তবে ব্যবহার করুন
        ...
        // সম্পূর্ণ সার্চ ফর্ম খুঁজে বের করার চেষ্টা করুন
        const allForms = document.querySelectorAll('form');
        allForms.forEach(function (form) {
          // এমনিতেই পরিচালিত মূল ফর্ম এড়িয়ে যান
        ...
        // গ্লোবাল ক্লিক ইভেন্ট লিসেনার
        document.addEventListener('click', function (e) {
          // সার্চ বাটন ক্লিক চেক করুন
          if (e.target.tagName === 'BUTTON' &&
            (e.target.textContent.includes('Search') ||
              e.target.textContent.includes('সার্চ') ||
              e.target.classList.contains('search-button'))) {

            console.log("Potential search button clicked:", e.target);

            // সবচেয়ে কাছের ইনপুট ফিল্ড খুঁজুন
            let input = null;
            let parent = e.target.parentElement;

            // বাটনের প্যারেন্ট এলিমেন্টের মধ্যে ইনপুট খুঁজুন
        ...
        // গ্লোবাল কীপ্রেস ইভেন্ট লিসেনার
        document.addEventListener('keypress', function (e) {
          if (e.key === 'Enter' && e.target.tagName === 'INPUT') {
            const input = e.target;
            const query = input.value.trim();

            // এমনিতেই পরিচালিত ইনপুট এড়িয়ে যান
